...
# JWT configuration
SECRET_KEY = os.getenv("JWT_SECRET_KEY")  # Ensure the JWT_SECRET_KEY is set in the environment
ALGORITHM = "HS256"
...
def create_access_token(data: dict) -> str:
    ...
    """
    to_encode = data.copy()  # Create a copy of the data dictionary to avoid modifying the original
    expire = datetime.now() + timedelta(minutes=ACCESS_TOKEN_EXPIRE_MINUTES)  # Use UTC time for consistency
